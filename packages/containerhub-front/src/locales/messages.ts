...
export const es = {
    ...
    stack: {crud: 'Stacks', field: {name: 'Nombre', services: 'Servicios'}},
    node: {crud: 'Nodos', field: {id: 'ID', hostname: 'Host', ip: 'IP', role: 'Rol', availability: 'Disponibilidad', state: 'Estado', engine: 'Motor', leader: 'Líder', reachability: 'Alcanzabilidad', agentHealthy: 'Agente', resources: 'Recursos'}},
    ghostcontainer: {crud: 'Contenedores huérfanos', field: {created: 'Creado', image: 'Imagen', status: 'Estado', id: 'ID', node: 'Nodo'}},
    network: {crud: 'Redes', field: {name: 'Nombre', created: 'Creada', driver: 'Driver', attachable: 'Adjuntable', ipamDriver: 'Driver IPAM', subnet: 'Subred', gateway: 'Gateway', createdFrom: 'Creada desde', createdTo: 'Creada hasta'}},
    ...
    taskmonitorization: {crud: 'Ciclo de vida de tareas', field: {date: 'Fecha', status: 'Evento', taskId: 'ID de tarea', nodeName: 'Nodo', serviceName: 'Servicio', modifiedBy: 'Modificado por'}},
    tasksMonitorization: {title: 'Ciclo de vida de tareas'},
    stacks: {
        title: 'Stacks',
        name: 'Nombre',
        services: 'Servicios',
...
export const en = {
    ...
    stack: {crud: 'Stacks', field: {name: 'Name', services: 'Services'}},
    node: {crud: 'Nodes', field: {id: 'ID', hostname: 'Host', ip: 'IP', role: 'Role', availability: 'Availability', state: 'State', engine: 'Engine', leader: 'Leader', reachability: 'Reachability', agentHealthy: 'Agent', resources: 'Resources'}},
    ghostcontainer: {crud: 'Ghost containers', field: {created: 'Created', image: 'Image', status: 'Status', id: 'ID', node: 'Node'}},
    network: {crud: 'Networks', field: {name: 'Name', created: 'Created', driver: 'Driver', attachable: 'Attachable', ipamDriver: 'IPAM driver', subnet: 'Subnet', gateway: 'Gateway', createdFrom: 'Created from', createdTo: 'Created to'}},
    ...
    taskmonitorization: {crud: 'Task lifecycle monitoring', field: {date: 'Date', status: 'Event', taskId: 'Task ID', nodeName: 'Node', serviceName: 'Service', modifiedBy: 'Modified by'}},
    tasksMonitorization: {title: 'Task lifecycle monitoring'},
    stacks: {
        title: 'Stacks',
        name: 'Name',
        services: 'Services',
