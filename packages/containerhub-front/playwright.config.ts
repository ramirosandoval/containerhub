...
export default defineConfig({
    ...
    webServer: [
        ...
        {
            command: 'VITE_BACKEND_PROXY=http://127.0.0.1:10000 npm run dev -- --force --host 127.0.0.1 --port 5173',
